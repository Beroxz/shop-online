...
<body class="d-flex flex-column min-vh-100">
                        ...
                        <div class="card-body px-5 py-5">
                            ...
                            <form class="row g-3 mt-2 needs-validation" novalidate method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control rounded-3" id="productQty" name="productQty" value="<?php echo $rowGetProducts["qty"]; ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="imgProduct" class="form-label fw-bold">ภาพสินค้า</label>
                                    <input type="hidden" class="form-control rounded-3" id="imgProductOld" name="imgProductOld" value="<?php echo $rowGetProducts["image"]; ?>">
                                    <input class="form-control" type="file" id="imgProduct" name="imgProduct" accept="image/png, image/jpg, image/jpeg" onchange="loadFile(event)">
                                </div>
    ...
    if (!empty($_POST["submit"])) {
        ...
        $imgProductOld = $conn->real_escape_string($_POST['imgProductOld']);

...
<body class="d-flex flex-column min-vh-100">
                    ...
                    <div class="card h-100 shadow rounded-4">
                        <div class="card-body px-5 py-5">
                            ...
                            <form class="row g-3 mt-2 needs-validation" novalidate method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="productTypeSub" class="form-label fw-bold">ประเภทย่อย <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="productQty" class="form-label fw-bold">จำนวนสินค้า<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control rounded-3" id="productQty" name="productQty" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="imgProduct" class="form-label fw-bold">ภาพสินค้า<span class="text-danger">*</span></label>
                                    <input class="form-control" type="file" id="imgProduct" name="imgProduct" accept="image/png, image/jpg, image/jpeg" onchange="loadFile(event)" required>
                                </div>
    ...
    if (!empty($_POST["submit"])) {
        ...
        $productQty = $conn->real_escape_string($_POST['productQty']);
        ...
        if ($num > 0) {
            ...
            if (!empty($_FILES['imgProduct']['tmp_name'])) {
                $imgPro1 = $_FILES['imgProduct']['tmp_name'];
                $imgPro1_name = $_FILES['imgProduct']['name'];
                ...
                $namePro1 = "imgProduct" . date("YmdHis") . "_1." . $last_imgPro1_name;
                copy($imgPro1, "../images/products/" . $namePro1);
            } else {
                $namePro1 = "";
            }
            
            $sqlInProducts = "INSERT INTO `products`(`sku`, `name`, qty,
            `type`, `subType`, `price`,
            `description`, `image`, 
            `status`, created_by, `create_at`) VALUES ('" . $sku . "','" . $productName . "','" . $productQty . "',
            '" . $productType . "','" . $productTypeSub . "','" . $productPrice . "',
            '" . $productDescription . "','" . $namePro1 . "',

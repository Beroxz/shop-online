...
<body class="d-flex flex-column min-vh-100">
                        ...
                        <div class="card-body px-5 py-5">
                            ...
                            <form class="row g-3 mt-3 needs-validation" novalidate method="post" action="" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-3" id="productTypeSub" name="productTypeSub" required>
                                </div>
    ...
    if (!empty($_POST["submit"])) {
        ...
        if ($num > 0) {
            ...
            $sqlInProductsTypeSub = "INSERT INTO `products_sub_type`(`pst_name`, `productd_type`) VALUES ('" . $productTypeSub . "','" . $productType . "')";
            $resInProductsTypeSub = mysqli_query($conn, $sqlInProductsTypeSub);
            if ($resInProductsTypeSub) {
    ?>
                <script type="text/javascript">
                    swal.fire({
                        title: "Successfully",
                        html: "เพิ่มซับประเภทสำเร็จแล้ว",
                        icon: "success",
                        timer: 2000,
                        allowOutsideClick: false
                    }).then(function() {

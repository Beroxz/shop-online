...
INSERT INTO `customers` (`user_name`, `firstname`, `lastname`, `email`, `tel`, `password`, `role`, `status`, `created_at`, `updated_at`) VALUES
('user', 'test', 'test', 'user@gmail.com', '0899851234', '579646aad11fae4dd295812fb4526245', 1, 1, '2024-03-13 20:18:36', '2024-03-19 04:53:32');
...
CREATE TABLE IF NOT EXISTS `districts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8914 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='InnoDB free: 8192 kB';
...
INSERT INTO `employees` (`user_name`, `firstname`, `lastname`, `email`, `password`, `role`, `status`, `plane`, `created_at`, `updated_at`) VALUES
('admin', 'admin1', 'web', 'admin@gmail.com', '579646aad11fae4dd295812fb4526245', 0, 1, 0, '2024-03-12 23:38:58', '2024-03-12 23:59:15');
...
CREATE TABLE IF NOT EXISTS `order_header` (
  ...
  `ship_address` text COLLATE utf8mb4_general_ci NOT NULL,
  `ship_sub_district` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `ship_district` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `ship_province` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `ship_postcode` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `total` int NOT NULL,
  `payment` int NOT NULL,
  `slip` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `parcel_number` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `status` int NOT NULL,
  `store_id` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime NOT NULL,
...
INSERT INTO `order_header` (`order_id`, `cus_id`, `ship_address`, `ship_sub_district`, `ship_district`, `ship_province`, `ship_postcode`, `total`, `payment`, `slip`, `parcel_number`, `status`, `store_id`, `created_at`, `updated_at`) VALUES
('ORDER24030001', 'user', 'test', '100402', '4', '1', '10500', 30690, 2, 'imgSlip20240319145655_1.png', '', 1, 'toys_store', '2024-03-19 14:56:55', '2024-03-21 12:49:58');
...
CREATE TABLE IF NOT EXISTS `order_line` (
  ...
  `line` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `order_line` (`id`, `order_id`, `line`, `product_id`, `qty`, `price`) VALUES
(1, 'ORDER24030001', '10000', '1', 1, 30690);
...
CREATE TABLE IF NOT EXISTS `prefix_order` (
  `keyname` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `prefix_order` (`keyname`, `val`, `seq`) VALUES
('year', '202403', 2);
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `image` varchar(1500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` int NOT NULL,
...
INSERT INTO `products` (`id`, `sku`, `name`, `qty`, `type`, `subType`, `price`, `description`, `image`, `status`, `created_by`, `create_at`, `updated_at`) VALUES
(1, '', 'FEBRTX4070TI -45 INTEL I9-14900KF 3.2GHz 24C/32T / Z790 / RTX 4070 TI 12GB / 32GB DDR5 5200MHz / M.2 500GB / 750W (80+GOLD) / CS360', 4, 8, 24, 30690, '<p><span style=\"background-color:#f1c40f\">*** กรณีที่ลูกค้าต้องการอัพเกรดสเป็กคอม กรุณาทักแชทเพื่อ สอบถามแอดมิน ***</span></p>\r\n\r\n<p>ของแถม</p>\r\n\r\n<p>- สติ๊กเกอร์ iHAVECPU</p>\r\n\r\n<p>- ข้าว ข้าวหอมมะลิ iHAVECPU 500 กรัม</p>\r\n\r\n<p>- เสื้อ iHAVECPU QUOTE RICE COMPUTER (SIZE L)</p>\r\n\r\n<p>- USB WIFI N150 MERCUSYS</p>\r\n\r\n<p>- คีย์แคป iHAVECPU X NVIDIA KEYCAP 1U MX STEM</p>\r\n\r\n<p>- RTX ON KEYCAP</p>\r\n\r\n<p>- กระเป๋าผ้า KINGSTON CANVAS BAG (WHITE GREEN)</p>\r\n\r\n<p>- ค้ำการ์ดจอ ANTEC DAGGER BLACK ARGB</p>\r\n\r\n<p>ของแถมมีจำนวนจำกัด</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>#ทำงาน</p>\r\n', 'imgProduct20240319113635_1.jpg', 1, 'toys_store', '2024-03-19 11:36:35', '2024-03-21 05:49:17');

-- --------------------------------------------------------

--
-- Table structure for table `products_sub_type`
--

DROP TABLE IF EXISTS `products_sub_type`;
CREATE TABLE IF NOT EXISTS `products_sub_type` (
  `pst_id` int NOT NULL AUTO_INCREMENT,
  `pst_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `productd_type` int NOT NULL,
  PRIMARY KEY (`pst_id`)
) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `products_sub_type`
--

INSERT INTO `products_sub_type` (`pst_id`, `pst_name`, `productd_type`) VALUES
(1, 'เสื้อผ้าผู้ชาย', 2),
(2, 'เสื้อผ้าผู้หญิง', 2),
(3, 'อุปกรณ์เสริมความงาม', 3),
(4, 'น้ำหอม', 3),
(5, 'ครีม โลชั่นบำรุงผิว', 3),
(6, 'สร้อยคอ จี้ แหวน กำไล ต่างหู เข็มกลัด', 7),
(7, 'แว่นตา', 7),
(8, 'จิวเวลลี่ เพชร พลอย อัญมณี คริสตัล', 7),
(9, 'นาฬิกา', 7),
(10, 'กระเป๋า เข็มขัดผู้หญิง', 14),
(11, 'กระเป๋า เข็มขัดผู้ชาย', 14),
(12, 'หมวก', 14),
(13, 'รองเท้าผู้ชาย', 15),
(14, 'รองเท้าผู้หญิง', 15),
(15, 'ตุ๊กตา', 5),
(16, 'เครื่องเล่นเกมส์', 5),
(17, 'ชุดโมเดล', 5),
(18, 'ของเล่นทั่วไป', 5),
(19, 'เสื้อผ้าเด็ก', 6),
(20, 'อาหารและอาหารเสริมสำหรับเด็ก', 6),
(21, 'เครื่องใช้เด็ก', 6),
(22, 'การศึกษา สารคดี', 11),
(23, 'การ์ตูน บันเทิง', 11),
(24, 'Desktop และ Laptop', 8),
(25, 'อุปกรณ์เสริม', 8),
(26, 'Tablet และ Ipad', 8),
(27, 'กล้องถ่ายรูป', 8),
(28, 'ที่ดิน คอนโด บ้าน', 12),
(29, 'หอพัก อพาร์ทเม้นท์ แมนชั่น', 12),
(30, 'อุปกรณ์อิเล็กทรอนิกส์', 16),
(31, 'โซฟา เก้าอี้ โต๊ะ', 16),
(32, 'ของตกแต่งภายในบ้าน', 16),
(33, 'เครื่องมือและอุปกรณ์', 13),
(34, 'วัสดุพื้นกระเบื่อง ไม้ ลามิเนต', 13),
(35, 'วัสดุตกแต่งภายนอก', 13),
(36, 'วัสดุตกแต่งภายใน', 13),
(37, 'วัสดุโครงสร้าง', 13),
(38, 'จักรยาน และจักรยานยนต์', 9),
(39, 'รถยนต์', 9),
(40, 'รถประเภทอื่นๆ', 9),
(41, 'โทรศัพท์มือถือ โทรศัพท์บ้าน', 4),
(42, 'อุปกรณ์เสริม เมมโมรี่ แบตเตอรี่', 4),
(43, 'ของสะสมทั่วไป', 10),
(44, 'เครื่องราง ของขลัง', 10),
(45, 'แสตมป์ เหรียญกษาปณ์', 10),
(46, 'ของชำร่วย ของขวัญ', 10),
(47, 'อาหารเสริมสุขภาพ', 17),
(48, 'แคปซูลสมุนไพร', 17),
(49, 'ชา กาแฟ เครื่องดื่มสุขภาพ', 17),
(50, 'อาหารทั่วไป', 17),
(51, 'ขนม', 17);
...
CREATE TABLE IF NOT EXISTS `products_type` (
  ...
  `pt_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`pt_id`)
...
(1, 'อื่นๆ'),
(2, 'เสื้อผ้าแฟชั่น'),
(3, 'เครื่องสำอาง ความงาม สุขภาพ'),
(4, 'โทรศัพท์ และอุปกรณ์สื่อสาร'),
(5, 'ของเล่น เกมส์'),
(6, 'แม่และเด็ก'),
(7, 'เครื่องประดับ'),
(8, 'คอมพิวเตอร์และเทคโนโลยี'),
(9, 'ยานพาหนะ'),
(10, 'ของสะสม'),
(11, 'หนังสือ และนิตยสาร'),
(12, 'อสังหาริมทรัพย์'),
(13, 'วัสดุก่อสร้าง'),
(14, 'กระเป๋า และเข็มขัด'),
(15, 'รองเท้า'),
(16, 'เครื่องใช้ภายในบ้าน'),
(17, 'อาหาร และอาหารเสริม');
...
CREATE TABLE IF NOT EXISTS `stores` (
  ...
  `id_card_number` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `img_id_card` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `img_house_registration` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `personal_address` text COLLATE utf8mb4_general_ci NOT NULL,
  `personal_sub_district` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `personal_district` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `personal_province` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `personal_postcode` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `personal_tel` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `store_address` text COLLATE utf8mb4_general_ci NOT NULL,
  `store_sub_district` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `store_district` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `store_province` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `store_postcode` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `store_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `store_tel` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `store_email` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `store_description` text COLLATE utf8mb4_general_ci NOT NULL,
  `store_category` int NOT NULL,
  `store_image` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `role` int NOT NULL,
  `status` int NOT NULL,
...
INSERT INTO `stores` (`user_name`, `firstname`, `lastname`, `password`, `sex`, `birth_date`, `id_card_number`, `img_id_card`, `img_house_registration`, `personal_address`, `personal_sub_district`, `personal_district`, `personal_province`, `personal_postcode`, `personal_tel`, `store_address`, `store_sub_district`, `store_district`, `store_province`, `store_postcode`, `store_name`, `store_tel`, `store_email`, `store_description`, `store_category`, `store_image`, `role`, `status`, `package`, `created_at`, `updated_at`) VALUES
('toys_store', 'test', 'test', '579646aad11fae4dd295812fb4526245', 1, '1999-02-19', '1730601220198', 'img-id-card-20240319041907_1.png', 'img-house-registration-20240319041907_1.png', 'test', '100201', '2', '1', '10300', '0899988888', 'test', '100201', '2', '1', '10300', 'toys store', '0899899999', 'toy_store@gmail.com', 'toys store', 5, 'store-image-20240319041907_1.jpg', 2, 1, 1, '2024-03-19 04:19:07', '2024-03-18 22:02:01');
...
INSERT INTO `store_payment` (`id`, `bank`, `account_name`, `branch`, `account_type`, `account_number`, `bank_type`, `qr_code`, `username`, `created_at`, `updated_at`) VALUES
(1, '', 'toys store', '', '', '12345678941', 2, 'qr-code-20240319105001_1.jpg', 'toys_store', '2024-03-19 10:55:59', '2024-03-19 04:25:37'),
(2, '1', 'toys store', 'วงเวียนใหญ่', 'เงินออม', '1111111111122', 1, '', 'toys_store', '2024-03-19 10:57:59', '2024-03-19 04:25:46'),
(3, '6', '12345678912', 'วงเวียนใหญ่', '', '1234567892', 1, '', 'toys_store', '2024-03-20 18:55:44', '2024-03-20 11:55:44'),
(4, '5', 'theerathep', 'สมุทรสาคร', '', '7692831013', 1, '', 'toys_store', '2024-03-20 18:59:21', '2024-03-20 11:59:21');
COMMIT;

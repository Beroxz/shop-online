...
<body class="d-flex flex-column min-vh-100">
                ...
                <div class="col mb-5">
                    <div class="card h-100 shadow rounded-4">
                        <div class="card-body px-5 py-5">
                            <h1 class="text-center fw-bold">สมัครสมาชิกทั่วไป</h1>
    ...
    ?>
            ...
            $sqlInCustomers = "INSERT INTO `customers`(`user_name`, `firstname`, `lastname`, 
            `email`, tel, `password`, `role`, 
            `status`, `created_at`) VALUES ('" . $username . "','" . $firstName . "','" . $lastName . "',
            '" . $email . "','" . $tel . "','" . md5(md5(md5($password))) . "','0',
            '1','" . date('Y-m-d H:i:s') . "')";

            // echo $sqlInCustomers;
            $resInCustomers = mysqli_query($conn, $sqlInCustomers);
